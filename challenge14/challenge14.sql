...
insert into mahasiswa (nim, nama, alamat, idJurusan) values ('N01', 'andre', 'kalimantan', 'J01'), ('N02', 'iqbal', 'bogor', 'J02'), ('N03', 'aidil', 'lamongan', 'J03');
...
insert into kontrak(idKontrak, nilai, nip, idMataKuliah, nim) values ('K001', 'A', 'A01', 'M01', 'N01'), ('K002', 'C', 'A02', 'M02', 'N02'), ('K003', 'A', 'A03', 'M04', 'N03');
insert into kontrak(idKontrak, nilai, nip, idMataKuliah, nim) values ('K004', 'B', 'A01', 'M03', 'N03'), ('K005', 'C', 'A02', 'M01', 'N02');